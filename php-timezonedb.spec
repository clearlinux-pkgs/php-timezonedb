...
Source0  : https://pecl.php.net/get/timezonedb-2025.1.tgz
...
%prep
%setup -q -n timezonedb-2025.1
cd %{_builddir}/timezonedb-2025.1
pushd ..
cp -a timezonedb-2025.1 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20240924/timezonedb.so
